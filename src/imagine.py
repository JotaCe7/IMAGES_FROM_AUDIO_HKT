...
def save_image_from_prompt(prompt: str):
  answers = stability_api.generate(
    prompt=prompt,
    seed=config_stability['seed'],
    steps=config_stability['steps'], 
    cfg_scale=config_stability['cfg_scale'],
    width=config_stability['width'], 
    height=config_stability['height'], 
    samples=config_stability['samples'], 
